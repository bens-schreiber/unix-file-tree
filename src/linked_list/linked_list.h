...
/// @param list 
static inline void linked_list_pop_head(linked_list_t *list) {
    linked_list_delete(list, list->head->data);
}

/// @brief Pops the end of the list.
/// @param list 
static inline void linked_list_pop_tail(linked_list_t *list) {
    linked_list_delete(list, list->tail->data);
}
